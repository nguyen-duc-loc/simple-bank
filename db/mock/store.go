...
// LisEntries mocks base method.
func (m *MockStore) LisEntries(arg0 context.Context, arg1 db.LisEntriesParams) ([]db.Entry, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "LisEntries", arg0, arg1)
	ret0, _ := ret[0].([]db.Entry)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// LisEntries indicates an expected call of LisEntries.
func (mr *MockStoreMockRecorder) LisEntries(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "LisEntries", reflect.TypeOf((*MockStore)(nil).LisEntries), arg0, arg1)
}
